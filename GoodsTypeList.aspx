<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GoodsTypeList.aspx.cs" Inherits="GoodsTypeList" Title="Untitled Page" %>
        ...
        <tbody>
            ...
            <tr>
                <td style="height: 44px">
                    ...
                    Total【<asp:Label ID="lblSumPage" runat="server"></asp:Label>】Page &nbsp; Current【<asp:Label
